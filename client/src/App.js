      ...
      <div className="container mt-3">
              ...
              <div className="card-body">
                ...
                <form onSubmit={nicknameSubmit}>
                  <div className="d-flex mb-3">
                    <input type="text" className="form-control" id="nickname" placeholder="Usuario" disabled={disabled} onChange={e => setNickname(e.target.value)} value={nickname} required/>
            ...
            <div className="card mt-3 mb-3 shadow border-0" id="content-chat">
              <div className="card-body">
                ...
                <small className="text-center text-muted"> Mensajes anteriores </small>
